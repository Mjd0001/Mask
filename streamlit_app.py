...
if uploaded_file is not None:
    ...
    image_gray = cv2.cvtColor(input_image_resized, cv2.COLOR_RGB2GRAY)

    input_image_scaled = image_gray/255.0

    input_image_reshaped = np.reshape(input_image_scaled, [1, 128, 128, 1]).astype(np.float32)
